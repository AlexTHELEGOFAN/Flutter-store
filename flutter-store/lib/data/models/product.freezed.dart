...
class _$_Product implements _Product {
  ...
  @override
  String toString() {
    return 'Product(id: $id, title: $title, description: $description, brand: $brand, price: $price, discountPercentage: $discountPercentage, rating: $rating)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, title, description, brand,
...
abstract class _Product implements Product {
  factory _Product(
      ...
      @JsonKey(name: 'rating') final double? rating) = _$_Product;
